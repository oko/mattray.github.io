...
bundle install --without development --path=.bundle
# cp ~/rpm.rb ~/chef-15.0.300/omnibus/.bundle/ruby/2.6.0/bundler/gems/omnibus-*/lib/omnibus/packagers/rpm.rb
bundle exec omnibus build chef -l internal
cp ~/chef-15.0.300/omnibus/pkg/chef*deb ~/
echo "15.0.300 Complete!"
echo `date`
