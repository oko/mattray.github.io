...
# Chef 14.14.29
cd
rm -rf ~/chef-14.14.29 ~/v14.14.29.tar.gz
sudo rm -rf /opt/chef
sudo mkdir /opt/chef
sudo chown omnibus:omnibus -R /opt/chef
wget https://github.com/chef/chef/archive/v14.14.29.tar.gz
tar -xzf v14.14.29.tar.gz
cd ~/chef-14.14.29/omnibus/
bundle install --without development --path=.bundle
bundle exec omnibus build chef -l internal
cp ~/chef-14.14.29/omnibus/pkg/chef*deb ~/

echo "14.14.29 Complete!"
echo `date`
